...
* A void function that creates a block of size 5 and child polongers for
...
/*!
	...
	\param Node *x is a polonger to a block to be split.
...
/*!
	...
	\param Node *a is a node polonger for traversal

	\param long i is the data to be removed

*/

void BPlusTree::HelpRemove(Node *a, long i)
